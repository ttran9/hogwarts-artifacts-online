...
public class UserController {
    ...
    public Result findAllUsers() {
        ...
        return new Result(true, StatusCode.SUCCESS.getHttpStatusCodeValue(), "Find All Success", userDtos);
    }
    ...
    public Result findUserById(@PathVariable Integer userId) {
        ...
        return new Result(true, StatusCode.SUCCESS.getHttpStatusCodeValue(), "Find One Success", userDto);
    }
    ...
    public Result addUser(@Valid @RequestBody HogwartsUser newHogwartsUser) {
        ...
        return new Result(true, StatusCode.SUCCESS.getHttpStatusCodeValue(), "Add Success", savedUserDto);
    }
    ...
    public Result updateUser(@PathVariable Integer userId, @Valid @RequestBody UserDto userDto) {
        ...
        return new Result(true, StatusCode.SUCCESS.getHttpStatusCodeValue(), "Update Success", updatedUserDto);
    }
